...
const ListShirtPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchShirts = async () => {
        try {
            ...
            const data = {
                ...
                nameTypeShirt: nametypeshirt || "", // Thêm giá trị nametypeshirt
    ...
    if (nameClub || namePlayer || nameSession || nametypeshirt) { // Thêm điều kiện kiểm tra nametypeshirt
        fetchShirts();
    }
}, [nameClub, namePlayer, nameSession, nametypeshirt]); // Thêm nametypeshirt vào dependencies
